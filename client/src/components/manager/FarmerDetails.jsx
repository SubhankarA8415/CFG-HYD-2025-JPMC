...
const FarmerDetails = () => {
  ...
  useEffect(() => {
    const fetchFarmers = async () => {
      try {
        const res = await fetch('/api/farmers/get');
  ...
  const sendAlert = async () => {
    ...
    try {
      const res = await fetch(`/api/farmers/alert`, {
        method: 'POST',
  ...
  const confirmDelete = async () => {
    try {
      await fetch(`/api/farmers/delete/${farmerToDelete.aadharNumber}`, {
        method: 'DELETE'
      });
  ...
  const submitEdit = async (data) => {
    try {
      const res = await fetch(`/api/farmers/update/${editFarmerData.aadharNumber}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
