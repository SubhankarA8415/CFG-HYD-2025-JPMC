...
export default function FarmerInsights() {
  ...
  const insights = [
    { id: 1, image: 'https://images.pexels.com/photos/1382102/pexels-photo-1382102.jpeg', title: 'Corn Crop Health Analysis', expert: 'Dr. Sarah Johnson', expertImage: 'https://images.pexels.com/photos/5876695/pexels-photo-5876695.jpeg', status: 'completed', timestamp: '2 hours ago', diagnosis: 'Nitrogen Deficiency', severity: 'moderate', recommendation: 'Apply nitrogen-rich fertilizer immediately. The yellowing in the lower leaves indicates nitrogen deficiency. Recommended dosage: 50kg/acre of urea fertilizer.', tips: ['Monitor soil moisture levels', 'Apply fertilizer during cool morning hours', 'Water thoroughly after application'], },
